...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<link rel="stylesheet" href="{{asset('styling/service.css') }}">
    ...
    <button type="submit">Add Car</button>
		...
		<div class="tabels">
			<div class="cars_display">
				<button id="showDivButton">Show Div</button>
				<table class=" border-2 text-xl border-red-500">
					<tr class=" font-bold">
						<th>NAMe</th>
						<th>ID</th>
						<th>IMAGE</th>
